...
from scripts.utils import load_and_merge_batches, log_message, select_n_samples

from scripts.convexity import graph_convexity
from scripts.similarity_metrics import cka, mutual_knn, cosine_similarity
...
def main(data_dir, model_name, output_dir):
    ...
    convexity_plot.savefig(f"{output_dir}/plots/convexity.pdf", format="pdf")
